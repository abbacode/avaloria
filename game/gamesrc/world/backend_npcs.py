...
quest_npc.desc = desc
quest_npc.db.quests = ['Have You Met The Slythain?', 'Have You Met The Green Warden?'] 
...
m += "part indeed.  I have some tasks for you.  Ask me about {Gquests{n to learn more."
aspect_of_karith.db.dialogue = { 'greeting': m }
aspect_of_karith.db.quests = ['Seal of Seals', 'Dark Places', 'Construct a Mine']
